...
def _extract_marker_pair(
    ...
    *,
    ...
    keeps the collector's cyclomatic complexity manageable.
    """
...
def main(argv: list[str] | None = None) -> int:
    ...
    # rather than skipping a missing CLI -- the fail-fast policy keeps
    # a silently-degraded run from looking like a clean pass.
