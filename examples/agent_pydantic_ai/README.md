...
```sh
uv sync --group agent-recipes
# (pip does not support PEP 735 dependency-groups; with pip, install the deps directly:
#   pip install pydantic-ai-slim langgraph langchain-core)
```
