...
# cache_creation=56727, visible=10, output=74, billed=56737.
# Source-of-truth shape for the cache-counted parser. The same
# captured JSON lives at tests/fixtures/claude_envelope_haiku.json;
# the inline copy here is what the test relies on so the suite stays self-contained.
...
# terminal_reason="error_during_execution"). The structural assertions
# below apply verbatim to a real live-captured refusal envelope.
...
# The stdout includes the cached-credentials preamble plus two MCP-discovery
# error lines before the JSON envelope. The tokens leaf carries the thinking
# surface (thoughts=20) the prior parser dropped. Same captured payload lives
# at tests/fixtures/gemini_envelope_flash.json.
