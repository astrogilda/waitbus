...
- CiStatusServer.get_capabilities: caps.resources is None branch.
...
# ---------------------------------------------------------------------------
# CiStatusServer.get_capabilities: resources is None branch
# ---------------------------------------------------------------------------
...
def test_get_capabilities_resources_none_branch() -> None:
    ...
    server = mcp_mod.CiStatusServer(name="t", version="0")
