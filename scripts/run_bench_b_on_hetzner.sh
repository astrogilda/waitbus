...
#       [--output bench_multistream_post_audit.json]
#
...
#
# Public-flip is NOT triggered by this script. Verdict + progress
...
LOCAL_OUTPUT="bench_multistream_post_audit.json"
...
echo "[hetzner-bench] NOTE: verdict is informational. No public-flip / publish step runs."
