...
Conformance is verified field-by-field against the CloudEvents v1.0.2 spec
(https://github.com/cloudevents/spec/blob/v1.0.2/cloudevents/spec.md) (REQUIRED attrs
