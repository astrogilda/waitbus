...
# Root-level narrative docs that quote the pattern in prose (the hygiene-rule
# description itself). They are not code and are excluded from the
# distribution, so they are skipped during the walk.
