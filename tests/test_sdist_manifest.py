...
retired in the 2026 packaging cut: the tests-in-sdist practice favours shipping
...
# Paths that must never appear in the sdist. `docs/research/` is the
# vendored deep-research artefact tree (a development aide, not a
# shipped consumer asset; the shipped surface is the code under
# `waitbus/` plus the consumer-facing top-level docs). The
# legacy `docs/research-cache` entry is kept for the v0.1.0-era cache
# that may resurface in a contributor's tree.
