...
# ----------------------------
# It does NOT publish anything, push any tag, or flip any public
# artifact regardless of soak verdict. The public flip is a separate
# manual operator step. Soak's role is to surface drift; operator
...
# A 24-hour run can outlive an edit to this file in the repo (a project-wide
# rename sweep edited it mid-run once, on 2026-06-07). Bash re-reads a running
...
echo "[soak] NOTE: verdict is informational. No public-flip / publish step runs."
