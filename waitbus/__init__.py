...
# import path -- the open-core seam the rest of the predicate machinery
# rides. The full module is private (_predicate); only the hook surface
# is re-exported here. These are cheap to import eagerly.
...
# coherent, symmetric public surface. Per the open-core separability rule
# the subscriber engine and `emit()` ARE the MIT-core contract. Their
# implementations live in PRIVATE modules (`_emit`,
