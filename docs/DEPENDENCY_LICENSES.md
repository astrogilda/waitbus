...
therefore redistribution-compatible with MIT for waitbus's use. certifi (MPL-2.0) is a weak-copyleft dependency that does not affect redistribution under the MIT license.
