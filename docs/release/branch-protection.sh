...
#
# Run ONCE by the operator immediately after the public-flip of
# astrogilda/waitbus (i.e., after the repo is made public and
# the first release tag has been pushed).  Safe to re-run: the PUT
...
#     runs on the free tier post-flip)
#
# Usage:
